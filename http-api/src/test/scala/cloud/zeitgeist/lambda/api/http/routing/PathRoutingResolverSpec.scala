...
import cloud.zeitgeist.lambda.api.http.http.{CognitoData, LambdaHTTPRequest, LambdaHTTPRequestContext, LambdaRequestContext}
import com.typesafe.scalalogging.LazyLogging
import org.scalatest.{MustMatchers, WordSpec}

class PathRoutingResolverSpec extends WordSpec with MustMatchers with LazyLogging {
  implicit val log = new Logger((string: String) => println(string))
