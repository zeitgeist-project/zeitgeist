...
package object macros {
  ...
  def get_impl(c: scala.reflect.macros.whitebox.Context)(route: c.Expr[String])(block: c.Expr[RouteBlockWithParams]): c.Expr[Any] = {
    ...
    val obj = q"""
    val handler = new cloud.zeitgeist.lambda.api.http.routing.HTTPGetRoute {
      def apply(requestContext: LambdaRequestContext): LambdaHTTPResponse = {
        $block(requestContext)
      }
    }

    addRoute(cloud.zeitgeist.lambda.api.http.http.GET, $route, handler)
    """
  ...
  def head_impl(c: scala.reflect.macros.whitebox.Context)(route: c.Expr[String])(block: c.Expr[RouteBlockWithParams]): c.Expr[Any] = {
    ...
    val obj = q"""
    val handler = new cloud.zeitgeist.lambda.api.http.routing.HTTPHeadRoute {
      def apply(requestContext: LambdaRequestContext): LambdaHTTPResponse = {
        $block(requestContext)
      }
    }

    addRoute(cloud.zeitgeist.lambda.api.http.http.HEAD, $route, handler)
    """
  ...
  def options_impl(c: scala.reflect.macros.whitebox.Context)(route: c.Expr[String])(block: c.Expr[RouteBlockWithParams]): c.Expr[Any] = {
    ...
    val obj = q"""
    val handler = new cloud.zeitgeist.lambda.api.http.routing.HTTPOptionsRoute {
      def apply(requestContext: LambdaRequestContext): LambdaHTTPResponse = {
        $block(requestContext)
      }
    }

    addRoute(cloud.zeitgeist.lambda.api.http.http.OPTIONS, $route, handler)
    """
  ...
  def postX_impl[T <: Product : c.WeakTypeTag](c: scala.reflect.macros.whitebox.Context)(route: c.Expr[String])(block: c.Expr[RouteXBlockWithBodyParams[T]]): c.Expr[Any] = {
    ...
    val obj = q"""
    val handler = new cloud.zeitgeist.lambda.api.http.routing.HTTPPostRoute[$tpe] {
      def apply(requestContext: LambdaRequestContext): LambdaHTTPResponse = {
    ...
    addRoute(cloud.zeitgeist.lambda.api.http.http.POST, $route, handler)
    """
  ...
  def put_impl[T <: Product : c.WeakTypeTag](c: scala.reflect.macros.whitebox.Context)(route: c.Expr[String])
    ...
    val obj = q"""
    val handler = new cloud.zeitgeist.lambda.api.http.routing.HTTPPutRoute[$tpe] {
      def apply(requestContext: LambdaRequestContext): LambdaHTTPResponse = {
        $block(requestContext)
      }
    }

    addRoute(cloud.zeitgeist.lambda.api.http.http.PUT, $route, handler)
    """
  ...
  def delete_with_body_impl[T <: Product : c.WeakTypeTag](c: scala.reflect.macros.whitebox.Context)(route: c.Expr[String])(block: c.Expr[T ⇒ LambdaHTTPResponse]): c.Expr[Any] = {
    ...
    val obj = q"""
        ...
        addRoute(cloud.zeitgeist.lambda.api.http.http.DELETE, $route, handler)
        """
...
*/
    ...
    val obj = q"""
        val handler = new cloud.zeitgeist.lambda.api.http.routing.HTTPDeleteRoute[Nothing] {
          def apply(requestContext: LambdaRequestContext): LambdaHTTPResponse = {
            $block(requestContext)
          }
        }
  ...
  def patch_impl[T <: Product : c.WeakTypeTag](c: scala.reflect.macros.whitebox.Context)(route: c.Expr[String])
    ...
    addRoute(cloud.zeitgeist.lambda.api.http.http.PATCH, $route, handler)
    """
